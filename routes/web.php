...
Route::middleware('app.auth')->group(function () {
    ...
    Route::middleware('app.super')->group(function () { //middleware superadmin
        // Master -> Jenis-php
    ...
    Route::middleware('level:1,2')->group(function () { // middleware super dan admin
        // Master -> obrik
    ...
    Route::prefix('rekap')->name('rekap.')->group(function () {
        ...
        Route::middleware('app.withOutObrik')->group(function () { //semua level kecuali obrik(3)
