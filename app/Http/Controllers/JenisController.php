            ...
            ->addColumn('action', function ($value) {
                return '
                    <div class="flex items-center justify-center gap-3 px-4 py-2">
                        ...
                        <a href="javascript:void(0)" data-id="' . $value->id_jenis_php . '" data-jenis_php="' . $value->jenis_php . '"  class="btn-editJenisPHP text-gray-500 hover:text-blue-600 transition duration-200" title="Edit">
