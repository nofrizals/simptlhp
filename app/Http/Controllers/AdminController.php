            ...
            ->addColumn('action', function ($value) {
                ...
                return '
                    <div class="flex items-center justify-center gap-3 px-4 py-2">
                        <a href="#" data-id="' . $value->id_user . '" title="Hapus" class="btn-deleteAdmin text-gray-500 hover:text-red-500 transition duration-200">
