...
class AdminController extends Controller
{
            ...
            ->addColumn('action', function ($value) {
                ...
                return '
                    <div class="flex items-center justify-center gap-3 px-4 py-2">
                        <a href="javascript:void(0)" data-id="' . $value->id_user . '" title="Hapus" class="btn-deleteAdmin text-gray-500 hover:text-red-500 transition duration-200">
                        ...
                        <a href="javascript:void(0)" data-simak="y" data-id="' . $value->id_user . '" data-opd="' . $value->kode_unor . '" data-id_pegawai="' . $value->id_pegawai . '" data-nama="' . $value->nama_pegawai . '" data-level="' . $value->tingkatan_level . '" data-obrikRadio="' . $value->obrikRadio . '" data-nama_obrik="' . $value->nama_obrik . '" data-tim="' . ($tims->id_tim ?? '') . '" class="btn-editAdmin text-gray-500 hover:text-blue-600 transition duration-200" title="Edit">
    ...
    public function store(Request $request)
    {
        ...
        $kode_unor = ($request->obrikRadio == 1) ? $request->nama_obrik : $request->opd;
        $data = [
            'kode_unor'         => $kode_unor,
            'id_app'            => 14,
