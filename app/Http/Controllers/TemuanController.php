            ...
            ->addColumn('action', function (Temuan $value): string {
                return '
                    <div class="flex items-center justify-center gap-3 px-4 py-2">
                        <a href="javascript:void(0)" data-id="' . $value->id_temuan . '" title="Hapus" class="btn-deleteTemuan text-gray-500 hover:text-red-500 transition duration-200">
                        ...
                        <a href="javascript:void(0)" data-id="' . $value->id_temuan . '"  class="btn-editTemuan text-gray-500 hover:text-blue-600 transition duration-200" title="Edit">
