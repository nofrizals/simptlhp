            ...
            ->addColumn('action', function (Rekomendasi $value): string {
                return '
                    <div class="flex items-center justify-center gap-3 px-4 py-2">
                        <a href="javascript:void(0)" data-id="' . $value->id_rekomendasi . '" title="Hapus" class="btn-deleteRekomendasi text-gray-500 hover:text-red-500 transition duration-200">
                        ...
                        <a href="javascript:void(0)" data-id="' . $value->id_rekomendasi . '"  class="btn-editRekomendasi text-gray-500 hover:text-blue-600 transition duration-200" title="Edit">
