    ...
    public function ajaxDataObrik(Request $request)
    {
        ...
        return DataTables::eloquent($data)
            ...
            ->editColumn('kode_instansi', function ($value) {
                return ucwords($value->kode_instansi ?? '-');
            })
            ...
            ->addColumn('action', function ($value) {
                return '
                    <div class="flex items-center justify-center gap-3 px-4 py-2">
                        ...
                        <a href="javascript:void(0)" data-id="' . $value->id_instansi . '" data-obrik="' . $value->nama_instansi . '"  class="btn-editObrik text-gray-500 hover:text-blue-600 transition duration-200" title="Edit">
