...
class TimController extends Controller
{
    ...
    {
        return view('pages.manajemen-tim.tim');
    }

    public function ajaxDataDaftarTim()
    {
        $data = Tim::orderBy('id', 'desc');
            ...
            ->addColumn('action', function ($value) {
                return '
                    <div class="flex items-center justify-center gap-3 px-4 py-2">
                        ...
                        <a href="javascript:void(0)" data-id="' . $value->id . '" data-name="' . $value->name . '"  class="btn-editTim text-gray-500 hover:text-blue-600 transition duration-200" title="Edit">
