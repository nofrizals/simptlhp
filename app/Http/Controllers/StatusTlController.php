    ...
    public function ajaxDataStatusTl()
    {
        ...
        return DataTables::eloquent($data)
            ...
            ->addColumn('status_tl', function ($value) {
                return ucwords($value->status_tl ?? '-');
            })
            ->addColumn('action', function ($value) {
                return '
                    <div class="flex items-center justify-center gap-3 px-4 py-2">
                        <a href="javascript:void(0)" data-id="' . $value->id_status . '" title="Hapus" class="btn-deleteStatusTl text-gray-500 hover:text-red-500 transition duration-200">
                        ...
                        <a href="javascript:void(0)" data-id="' . $value->id_status . '" data-status_tl="' . $value->status_tl . '"  class="btn-editStatusTl text-gray-500 hover:text-blue-600 transition duration-200" title="Edit">
