    ...
    public function ajaxPeraturan()
    {
        ...
        return DataTables::eloquent($data)
            ...
            ->addColumn('status', function ($value): string {
                if ($value->edited_by) {
                    return 'Diedit oleh <strong>' . e($value->editedBy->nama_pegawai ?? 'Admin Infokom') . '</strong><br>'
                        . optional(Carbon::parse($value->edited_at ?? '-'))->translatedFormat('d F Y');
                } else {
                    return 'Ditambah oleh <strong>' . e($value->createdBy->nama_pegawai ?? 'Admin Infokom') . '</strong><br>'
            ...
            ->addColumn('action', function ($value): string {
                return '
                    <div class="flex items-center justify-center gap-3 px-4 py-2">
                        <a href="javascript:void(0)" data-id="' . $value->id_peraturan . '" title="Hapus" class="btn-deletePeraturan text-gray-500 hover:text-red-500 transition duration-200">
                        ...
                        <a href="javascript:void(0)" data-id="' . e($value->id_peraturan) . '" data-judul="' . e($value->judul) . '" data-keterangan="' . e($value->keterangan) . '" data-file="' . e($value->file) . '" class="btn-editPeraturan text-gray-500 hover:text-blue-600 transition duration-200" title="Edit">
