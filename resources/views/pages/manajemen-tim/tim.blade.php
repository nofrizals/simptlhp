...
@section('content')
    <div class="p-4 mx-auto max-w-(--breakpoint-2xl) md:p-6">
        <div x-data="{ pageName: `Manajemen Daftar Tim` }">
        ...
        <div class="space-y-5 sm:space-y-6">
            <div class="relative border-t border-gray-100 p-5 sm:p-6 dark:border-gray-800">
                ...
                <table id="timTable" class="min-w-full divide-y divide-gray-200 display">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Nama Tim</th>
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (response.status === false) {
                                ...
                                closeModal();
                                if ($.fn.DataTable.isDataTable('#timTable')) {
                                    $('#timTable').DataTable().ajax.reload(null,
                                        false);
                                }
                                Swal.fire({
                                    title: "Sukses",
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    if (response.status) {
                                        $('#timTable').DataTable().ajax.reload(
                                            function() {
                                                Swal.fire({
                                                    title: "Sukses",
                                                    text: response.message,
