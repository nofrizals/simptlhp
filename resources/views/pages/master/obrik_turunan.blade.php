        ...
        <div class="space-y-6">
            <div
                ...
                <div
                    ...
                    {{-- SEARCH --}}
                    <div class="relative">
                        <input id="customSearch" type="text" placeholder="Cari obrik turunan..."
                    ...
                    <table id="dataTable" class="min-w-full text-sm">
                        <thead class="bg-gray-50 dark:bg-gray-800">
                            <tr>
                                ...
                                <th class="px-6 py-4 text-left text-xs font-semibold uppercase text-gray-500">Kode Instansi
                                </th>
                                <th class="px-6 py-4 text-left text-xs font-semibold uppercase text-gray-500">Nama OPD
                                </th>
                                <th class="px-6 py-4 text-left text-xs font-semibold uppercase text-gray-500">Nama Korwil /
                                    UPTD / Kelurahan / Kampung
                                </th>
                        ...
                        <div class="-mx-2.5 flex flex-wrap gap-y-5">
                            ...
                            <div class="w-full px-2.5">
                                ...
                                <select name="kode_unor" id="kode_unor"
                                    ...
                                    <option value="01.13">Dinas Kesehatan</option>
                                    <option value="01.23">Dinas Pendidikan dan Kebudayaan</option>
                            ...
                            <div class="w-full px-2.5">
                                <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                    Nama Korwil / UPTD / Kelurahan / Kampung
                                </label>
                                <input type="text" name="nama_turunan" id="nama_turunan" placeholder=""
                                    class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
    ...
    @push('scripts')
        <script>
            $(document).ready(function() {
                ...
                // ─── URL ───────────────────────────────────────────────
                const URL = {
                    ajaxObrikTurunan: "{{ url('ajax-data-obrik-turunan') }}",
                    storeObrikTurunan: "{{ url('obrik-turunan') }}",
                };
                ...
                $(document).on('click', '.btn-editObrik', function() {
                    ...
                    openModal();
                    $('.modal-header').html(
                        'Form Edit Obrik Turunan');
                    $('#id').val(data.id);
                    $('#kode_unor').val(data.instansi.substr(0, 5));
                    $('#nama_turunan').val(data.turunan);
                });
