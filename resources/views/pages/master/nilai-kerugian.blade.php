    ...
    @push('scripts')
        <script>
            $(document).ready(function() {
                ...
                // ─── URL ───────────────────────────────────────────────
                const URL = {
                    ajaxNilaiKerugian: "{{ url('ajax-data-nilai-kerugian') }}",
                    storeNilaiKerugian: "{{ url('nilai-kerugian') }}",
                };
