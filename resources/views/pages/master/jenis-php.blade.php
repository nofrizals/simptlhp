    ...
    @push('scripts')
        <script>
            $(document).ready(function() {
                ...
                // ─── URL ───────────────────────────────────────────────
                const URL = {
                    ajaxJenisPhp: "{{ url('ajax-data-jenis-php') }}",
                    storeJenisPhp: "{{ url('jenis-php') }}",
                };
