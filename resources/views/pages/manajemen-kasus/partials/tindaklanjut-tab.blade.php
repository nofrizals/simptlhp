                        ...
                        <div class="w-full px-2.5 xl:w-1/2">
                            <div class="flex gap-3">
                                <div class="w-1/2">
                                    ...
                                    <p class="err text-theme-xs text-error-500" id="tgl_tindak_lanjut_error"></p>
                                </div>
                                <div class="w-1/2">
                                    <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                        ...
                        <div class="w-full px-2.5 xl:w-1/2">
                            <div class="flex gap-3">
                                <div class="w-1/2">
                                    ...
                                    <p class="err text-theme-xs text-error-500" id="tindak_lanjut_error"></p>
                                </div>
                                <div class="w-1/2">
                        ...
                        <div class="space-y-5 p-6">
                            ...
                            <div class="grid grid-cols-3 gap-4 items-start">
                                ...
                                <div class="col-span-2">
                                    ...
                                    <p id="rincian_keuangan_error" class="err mt-1 text-xs text-red-500"></p>
                                </div>
                            ...
                            <div class="grid grid-cols-3 gap-4 items-start">
                                ...
                                <div class="col-span-2">
                                    ...
                                    <p id="rincian_keuangan2_error" class="err mt-1 text-xs text-red-500"></p>
                                </div>
                            ...
                            <div class="grid grid-cols-3 gap-4 items-start">
                                ...
                                <div class="col-span-2">
                                    ...
                                    <p id="rincian_keuangan3_error" class="err mt-1 text-xs text-red-500"></p>
                                </div>
                            ...
                            <div class="grid grid-cols-3 gap-4 items-start">
                                ...
                                <div class="col-span-2">
                                    ...
                                    <p id="rincian_keuangan4_error" class="err mt-1 text-xs text-red-500"></p>
                                </div>
