                    ...
                    <div>
                        <div class="mb-5 sm:mb-8">
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">
                                Masukkan NIP/NIK serta password yang terdaftar!
                            </p>
                        </div>
                        <div>
                            <form id="formLogin">
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div>
                                        <label
                                            ...
                                            NIP/NIK<span class="text-error-500">*</span>
                                        </label>
                                        <input type="text" id="nip" name="nip"
                                            placeholder="Masukkan NIP/NIK"
                                            class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" />
                                        <small class="err text-theme-xs text-error-500" id="nip_error"></small>
                                    </div>
                                    <!-- Password -->
                                    <div>
                                        <label
        ...
        $(document).ready(function() {
            ...
            $('#formLogin').submit(function(e) {
                ...
                $.ajax({
                    ...
                    beforeSend: function() {
                        $('.err').html('');
                        let loading = `<svg aria-hidden="true" class="w-5 h-5 text-neutral-tertiary animate-spin fill-brand"
                        ...
                        <span>Loading...</span>`
                        $('#loginBtn').prop('disabled', true).addClass(
