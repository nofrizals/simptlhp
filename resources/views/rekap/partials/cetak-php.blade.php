<div
    ...
    <div class="p-6">
        <div id="printMe" class="overflow-auto pb-4">
            ...
            <table class="tablexls w-3/4 text-xs text-gray-700 dark:text-white/90" border="0">
                <tr>
                ...
                <table class="tablexls min-w-full border border-gray-300 text-xs dark:border-white/90">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="11"
                                    class="border border-gray-300 px-2 py-4 text-center dark:border-white/90 dark:text-white/90">
                                    Tidak ada data temuan.
                                </td>
                            </tr>
                        @endforelse
                        <tr class="font-semibold">
                            <td class="border border-gray-300 px-2 py-2 dark:border-white/90"></td>
                            <td class="border border-gray-300 px-2 py-2 dark:border-white/90"></td>
                            <td class="border border-gray-300 px-2 py-2 dark:border-white/90"></td>
                            <td class="border border-gray-300 px-2 py-2 dark:border-white/90"></td>
                            <td class="border border-gray-300 px-2 py-2 dark:border-white/90"></td>
                            <td
                                class="border border-gray-300 px-2 py-2 text-right dark:border-white/90 dark:text-white/90">
            ...
            <table class="tablexls w-full text-xs" border="0">
                <tr>
                    <td width="40%"></td>
                    <td width="35%" class="text-left dark:text-white/90">SIAK SRI INDRAPURA,
                        {{ now()->translatedFormat('d F Y') }}
                    </td>
                </tr>
                <tr>
                    <td class="text-left"></td>
                    <td class="text-left dark:text-white/90">INSPEKTUR KABUPATEN SIAK</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="text-left"></td>
                    <td class="text-left dark:text-white/90"><u>{{ $ttd->nama_pegawai ?? '-' }}</u></td>
                </tr>
                <tr>
                    <td class="text-left"></td>
                    <td class="text-left dark:text-white/90">NIP {{ $ttd->id_pegawai ?? '-' }}</td>
                </tr>
            </table>
        </div>
    </div>
    ...
    <div class="flex items-center justify-between border-t border-gray-200 px-6 py-4 dark:border-gray-800">
        <div class="text-sm text-gray-500 dark:text-white/90">
            @if (empty($rows))
