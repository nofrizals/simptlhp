    ...
    <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        ...
        <div :class="menuToggle ? 'flex' : 'hidden'"
            ...
            <button
                ...
                <svg class="hidden dark:block dark:text-white" width="20" height="20" viewBox="0 0 20 20"
            ...
            <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                <a class="flex items-center text-gray-700 dark:text-gray-400" href="#"
                    ...
                    <span class="mr-3 h-11 w-11 overflow-hidden rounded-full dark:brightness-9 dark:invert">
                        <img src="{{ asset('images/user/simptlhp.png') }}" alt="User" />
                    </span>

                    <span class="text-theme-sm mr-1 block font-medium dark:text-white/90"> {{ session('nama') }} </span>

                    <svg :class="dropdownOpen && 'rotate-180'"
                        class="stroke-gray-500 dark:stroke-gray-400 dark:stroke-white" width="18" height="20"
                ...
                <div x-show="dropdownOpen"
                    ...
                    <div>
                        ...
                        <span class="text-theme-xs mt-0.5 block text-gray-500 dark:text-white/90">
                            {{ session('nip') }}
                        </span>
                    </div>
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        ...
                        <button
                            ...
                            <svg class="fill-gray-500 group-hover:fill-gray-700 dark:group-hover:fill-white/90"
